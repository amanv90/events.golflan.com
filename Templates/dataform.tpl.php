...
<body>
	...
	<input type="hidden" name="redirect_url" value="http://golflan.com/ccavResponseHandler.php"/>
	<input type="hidden" name="cancel_url" value="http://golflan.com/ccavResponseHandler.php"/>
