...
function updatCalendar(){
    var gid = $('#gid').val();
    var bookType= $('#booking_type1').val();
    if(gid !="" && (bookType == 2)){
        $.ajax({
...
//                    var numberOfDaysToAdd = 4;
                    ...
                    $('#play_date1').datepicker('remove');
                    $('#play_date1').datepicker({
                        startDate :someDate,
                        format:'dd/mm/yyyy',
                        beforeShowDay: enableAllTheseDays,
                        autoclose: true
                    });
                    $('#play_date1').datepicker().on('changeDate', function (ev) {
...
function submit_comp1_booking(){
    ...
    var booking_type1 = $('#booking_type1').val();
    if($('#form-compl').valid()){
...
function updatRateCard(){
    var bookingType = $('#booking_type1').val();
    var gid = $('#gid').val();
    var play_date =$('#play_date1').val();
    var play_time = $('#play_time1').val();
    if($('#play_date1').val()=="" || $('#play_time1').val()==""){
        return false;
    }
   if(bookingType == 2){
